...
class StartMeetingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let fetchRequest: NSFetchRequest<Storage>
        ...
        do {
            ...
            let loginDataObject: NSManagedObject = objects[0]
            
            let name = loginDataObject.value(forKey: "uname") as! String
            let email = loginDataObject.value(forKey: "email") as! String
